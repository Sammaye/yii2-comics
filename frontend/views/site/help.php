...
<div class="site-faq">
    ...
    <div class="row">
        <div class="col-sm-48">
            ...
            <p>When emailing me please try and explain your problem as much as possible, including screenshots if needs
                be.</p>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div id="faq-affix" class="faq-affix">
        ...
        <div class="col-sm-36">
            ...
            <div class="faq-item">
                ...
                <p>This site is a new comic destribution service I made for my own personal use which I have decided to
                    release to the general internet community.</p>
                <p>Essentially it allows you batch, for free, your daily comics across the internet and have them sent
            ...
            <div class="faq-item">
                ...
                <p><a href="mailto:before_i_sleep@hotmail.co.uk?subject=Please Add A Comic I Like">You can email me at
                    my public inbox</a> with the needed information.</p>
                <p>The only information I need is the name of the comic and its homepage URL.</p>
                <p>There may be some comics that, due to their setup, might not be crawlable. You will be notified if
                    the comic you want
            ...
            <div class="faq-item">
                ...
                <p>Many sites also implemented extremely intrusive advertising if you didn't cough up. GoComics was one
                ...
                <p>Fair enough, I could use an Ad Blocker, but then how is that any different to just making this
                    service in terms of "support" (remember that ads pay money).
                    Not only that but I still have all those tabs and websites to check every day!</p>
                <p><b>Why not just make this service and make my life easier by spending maybe a week of my time making
                    it?</b></p>
                <p>I am not the sort to shy from paying money but I find it difficult to see how the &dollar;11 (&pound;6.87)
                    a year I pay to GoComics really helps the cartoonists
            ...
            <div class="faq-item">
                ...
                <p>Name me a site that allows login and a user account section that doesn't and is slightly
                    secure...</p>
                <p>In other words: yes.</p>
                <p>The cookies used on this site are:</p>
                <ul>
                    <li>login cookies, in which case we may use two individual cookies to identify you as who you say
                        you are
                    </li>
                    <li>analytical cookies, namely for Google Analytics</li>
                    <li>third party cookies that are out of my control, for example: YouTube could be used on this site
                        and they in turn use cookies of their own
                    </li>
                </ul>
            ...
            <div class="faq-item">
                ...
                <p>As a fore-warning, that could change to include non-intrusive advertising at a later date if this
                    site expands to take a significant budget or
                    third party pressure causes me to pay a significant amount.</p
                <p>I intend to never make money (for site maintenance or third party payments) from this site by
                    charging for it.</p>
            </div>
            ...
            <div class="faq-item">
                ...
                <p>I am not pretending to have ownership over these cartoons nor do I claim to be their author. Instead
                    I am just an average guy who wanted to get his daily dose of
                    cartoon fever in an easy to manage email subscription.</p>
                <p>I clearly and visually label the name of the cartoons and their authors, including the registered
                    homepage for that cartoon.</p>
            ...
            <div class="faq-item">
                ...
                <p>There are two options: either you send a forgettable list of emails to be sent your comic by a set
                    schedule or you actally merge your user subscription services with my own,
                    allowing your visitors to signup to this service straight from your comic.</p>
                <p>If you are interested in using this distribution service yourself
                    <a href="mailto:before_i_sleep@hotmail.co.uk?subject=I am interested in using your service">
                        let me know by emailing me
                    </a> and I would be quite excited to work wth you.</p>
            </div>

            <div class="faq-item">
                <span id="earn-money" class="head-anchor"></span>
                <h3>Can I earn money from my cartoon on your network?</h3>
                <p>Not currently, however, if this were to become serious I would look into allowing royalties and for
                    cartoonists to advertise their books/merchandise.</p>
                <p>I am reluctant to allow paid ads within emails like they do in Dilbert emails since those ads really
                    suck and have no reference to those who actually
                    read Dilbert. I mean seriously; why would I want to see some random, spammy looking, site
                    advertising holidays to Antarctica?</p>
            </div>

            <div class="faq-item">
                <span id="dmca" class="head-anchor"></span>
                <h3>I want to sue/DMCA you!</h3>
                <p>This is nothing more than a pesonal project that I have shared to others who might be interested in
                    it, however, if you really want
                    to go ahead with this you
                    <a href="mailto:before_i_sleep@hotmail.co.uk?subject=DMCA or Sueing">can email me about it</a>.
                </p>
            </div>
            ...
            <div class="faq-item faq-tac">
                ...
                <p>If I decide to change the emails you recieve (say, to add a newsletter about really awesome news
                ...
                <p>This process should not take more than 48 hours however, if after that time you still have not been
                    deleted please
                    <a href="mailto:before_i_sleep@hotmail.co.uk?subject=My account is not deleting">let me know via email</a>
